...
class PortfolioApp extends PolymerElement {
  static get template() {
    ...
    <div class="toolbar-wrapper">
      <app-header class="toolbar-container">
        <app-toolbar class="toolbar">
          ...
          <paper-button id="blog" class="menu-button-getter menu-button body-text" disabled><iron-icon icon="vaadin:newspaper" class="vaadin-menu-icon"></iron-icon><span class="menu-icon-text">Blog</span></paper-button>
    ...
    <app-drawer style="visibility:hidden" class="drawer" closed align="right">
      <div class="drawer-button-wrapper">
        <paper-button id="blog" class="drawer-button menu-button-getter" disabled><iron-icon icon="vaadin:newspaper" class="drawer-icon"></iron-icon>Blog</paper-button>
      </div>
      <div class="drawer-button-wrapper">
    ...
    <div class="banner-description" style="line-height:1.7em;">
    Hey I'm Niye, thanks for stopping by!<br>I'm a primarily <span style="color:#00cc00">server-side</span> developer with an eye for <span style="color:#00cc00;">quality</span>.
    </div>
    </div>
    <div class="banner-button-wrapper frame">
    <paper-button class="banner-button" raised toggles>Contact Me</paper-button>
    </div>
    </div>
    ...
    <div class="header-wrapper contact-tag">
    <div class="header-container frame">
    <div class="header">
    <div class="header-title">Contact<br><br></div>
    <div class="header-description">Feel free to get in touch using the form below. You can also email me at <span style="color:#3333ff;">niyeturner@gmail.com</span> <br>or using one of the social media platforms beneath this form.</div>
    </div>
    </div>
    </div>
    ...
    <form action="" method="" id="FORM_1" style="width:100vw;display:flex;justify-content:center;" class="">

    <div class="custom-parent">
      <paper-input class="custom" label="Name" value="" always-float-label>
      </paper-input>
      <paper-input class="custom" label="Email" always-float-label auto-validate pattern="[a-zA-Z]*">
      </paper-input>
      <paper-textarea class="custom" label="Message" style="height:15em" always-float-label>
      </paper-textarea>
      <input id="INPUT_9" class="contact-send-button" type="submit" value="Send" action="">
    </div>
</form>
    <style>
    #FORM_1 {
    ...
    <div class="footer-description frame footer-piece title-text">Self taught developer, passionate visionary, and nature lover.<br>Hope you found what you were looking for.</div>
    ...
    <iron-icon class="twitter-icon footer-icon" icon="inline:shape" role="img" aria-label="A shape"></iron-icon>
    </a>
    </div>
    ...
    <iron-icon class="github-icon footer-icon" icon="inline:shape" role="img" aria-label="A shape"></iron-icon>
    </a>
    </div>
    ...
    <iron-icon class="linkedin-icon footer-icon" icon="inline:shape" role="img" aria-label="A shape"></iron-icon>
    </a>
    </div>
  ...
  mobileStyles(){
    ...
    // contact_inputs.forEach((currentValue)=>{currentValue.style.width=""})
  }
  hardStyles(){
    this.headerStyle()
    this.footerStyle()
  ...
  load_projects(){
    ...
    window.projects.forEach(function(currentValue,index){
      ...
      <div class="card-container frame">
      <div class="project-image-wrapper" style="background-image:url('${currentValue.image}');background-size:cover;background-size:contain;background-position:center;background-repeat:no-repeat;"></div>
      </div>
      </div>
      </a>
      `;
